...
owner_phone_1=os.environ.get("OWNER_PHONE_1") # Owner's phone number with countrycode
owner_phone_2=os.environ.get("OWNER_PHONE_2") # Owner's phone number with countrycode
owner_phone_2=os.environ.get("OWNER_PHONE_3") # Owner's phone number with countrycode
owner_phone_2=os.environ.get("OWNER_PHONE_4") # Owner's phone number with countrycode
