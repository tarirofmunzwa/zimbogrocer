...
Reference: {order_id}
"
            f"Please remember to send the Proof of Payment as soon as you make payment.
Have a nice day.

"
            f"2. Pay at supermarkets using Mukuru wicode
"
            f"3. World Remit Transfer (on request)
"
            f"4. Western Union (on request)
